...
<div id="kz-menu-flotante" class="kz-menu kz-menu-oculto">
    <a class="kz-menu-item" href="https://wa.me/+50687672300" target="_blank" rel="noopener noreferrer">
    ...
    <a class="kz-menu-item" href="https://www.kaizenapps.net/es/agendar" target="_blank" rel="noopener noreferrer">
        <span class="kz-menu-icon" aria-hidden="true">
    ...
    <a class="kz-menu-item" href="https://kaizenapps.net/" target="_blank" rel="noopener noreferrer">
        <span class="kz-menu-icon" aria-hidden="true">
...
<style>
    .kz-bubble-btn { position:fixed; bottom:24px; left:24px; z-index:9999; width:56px; height:56px; border-radius:50%; border:none; cursor:pointer; background:#b22222; box-shadow:0 4px 20px rgba(178,34,34,.45),0 2px 8px rgba(0,0,0,.2); display:grid; place-items:center; transition:transform .25s cubic-bezier(.22,1,.36,1),box-shadow .25s ease; outline:none; }
    .kz-bubble-btn:hover { transform:scale(1.08) translateY(-2px); box-shadow:0 8px 28px rgba(178,34,34,.55),0 4px 12px rgba(0,0,0,.25); }
    .kz-bubble-btn:active { transform:scale(.96); }
    .kz-bubble-btn img { width:34px; height:34px; object-fit:contain; pointer-events:none; }
    .kz-menu { position:fixed; bottom:92px; left:24px; z-index:9998; display:flex; flex-direction:column; gap:8px; transform-origin:bottom left; transition:opacity .2s ease,transform .25s cubic-bezier(.22,1,.36,1); }
    .kz-menu-oculto { opacity:0; transform:scale(.85) translateY(8px); pointer-events:none; }
    .kz-menu-visible { opacity:1; transform:scale(1) translateY(0); pointer-events:auto; }
    .kz-menu-item { display:flex; align-items:center; gap:10px; padding:10px 16px 10px 12px; border-radius:40px; background:#b22222; color:#fff; text-decoration:none; font-family:'Outfit',system-ui,sans-serif; font-size:14px; font-weight:500; white-space:nowrap; box-shadow:0 3px 14px rgba(178,34,34,.35),0 1px 6px rgba(0,0,0,.18); transition:transform .18s cubic-bezier(.22,1,.36,1),box-shadow .18s ease,filter .18s ease; align-self:flex-start; }
    .kz-menu-item:hover { transform:translateX(4px) scale(1.03); box-shadow:0 6px 20px rgba(178,34,34,.5),0 2px 8px rgba(0,0,0,.2); filter:brightness(1.08); }
    ...
    .kz-menu-visible .kz-menu-item:nth-child(1) { animation:kzIn .2s ease 0s both; }
    .kz-menu-visible .kz-menu-item:nth-child(2) { animation:kzIn .2s ease .04s both; }
    .kz-menu-visible .kz-menu-item:nth-child(3) { animation:kzIn .2s ease .08s both; }
    .kz-menu-visible .kz-menu-item:nth-child(4) { animation:kzIn .2s ease .12s both; }
