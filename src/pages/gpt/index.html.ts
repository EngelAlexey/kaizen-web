...
const bubbleHTML = `
    ...
    <style>
        ...
        .kz-menu { position: fixed; bottom: 92px; left: 24px; z-index: 9998; display: flex; flex-direction: column; gap: 8px; transform-origin: bottom left; transition: opacity 0.2s ease, transform 0.25s cubic-bezier(.22,1,.36,1); }
...
<body>
    <iframe src="https://ssoma-kaizen-web.onrender.com" title="GPT"></iframe>
    ${bubbleHTML}
</body>
</html>`;
